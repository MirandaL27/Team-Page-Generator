...
test("testing the output of the parseHTML helper function", () =>{
    ...
    let expected = ["header",".hero",".about-me",".about-me-header",".work",".work-header",".work-links",".contact-me",".contact-me-header",".contact-me-list","h2"];
...
//     expect(generateCSS.generateCSS(html)).toMatch(/body{[\s]*font-family:Arial, Helvetica, sans-serif;[\s]*background-color: powderblue;[\s]*}[\s]*a{[\s]*color: white;[\s]*display: block;[\s]*}[\s]*header{[\s]*background-color: blue;[\s]*color: white;[\s]*border: 3px solid black;[\s]*}[\s]*[.]manager{[\s]*background-color: rgb(179, 88, 231);[\s]*color: white;[\s]*border: 3px solid black;[\s]*border-radius: 10px;[\s]*}[\s]*[.]engineer{[\s]*background-color: slateblue;[\s]*color: white;[\s]*border: 3px solid black;[\s]*border-radius: 10px;[\s]*}[\s]*[.]intern{[\s]*background-color: rgb(230, 102, 247);[\s]*color: white;[\s]*border: 3px solid black;[\s]*border-radius: 10px;[\s]*}[\s]*$/);
